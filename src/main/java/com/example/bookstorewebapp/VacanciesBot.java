...
import com.example.bookstorewebapp.service.VacancyService;
...
//    }
    ...
    private ReplyKeyboard getVacanciesMenu(List<BookDto> vacancies) {
        List<InlineKeyboardButton> row = new ArrayList<>();
        for (BookDto vacancy : vacancies) {
    ...
    private ReplyKeyboard getJuniorVacanciesMenu() {
        ...
        List<BookDto> vacancies = vacancyService.getJuniorVacancies();
